...
<template>
  <div @wheel="handleWheel" class="numberscroller">
    <div v-for="n of numbers" :key="n" @click="handleClickNumber(n)" @mouseover="isScrollable = true"
      @mouseout="isScrollable = false" :class="{ 'numberscroller-current': n === props.current }"
